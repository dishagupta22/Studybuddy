...
def delete_note(request, pk=None):
    Notes.objects.get(id=pk).delete() #delete on given primary key row
...
def delete_homework(request, pk=None):
    Homework.objects.get(id=pk).delete() #delete on given primary key row
    return redirect("homework")
...
def delete_todo(request, pk=None):
    Todo.objects.get(id=pk).delete() #delete on given primary key row
    return redirect("todo")
